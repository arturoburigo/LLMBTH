...
if (!estagiario.codESocial.equals("901")) {
    suspender "Este cálculo é executado apenas para bolsa de estudos do estagiário com o 'Código eSocial' igual a '901' informado na categoria do trabalhador"
}
